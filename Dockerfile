...
# COPIED FROM https://hub.docker.com/_/node
...
WORKDIR /usr/src/app
ADD dist ./
COPY docker-entrypoint.sh /usr/src/bin/
COPY run-service.sh /usr/src/bin/
COPY default.conf /etc/nginx/conf.d
RUN chmod 700 /usr/src/bin/*
...
CMD  ["sh", "/usr/src/bin/run-service.sh"]
